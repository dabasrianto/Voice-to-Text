...
interface LottieAnimation10Props {
  isRecording?: boolean;
  audioLevel?: number;
  isPaused?: boolean;
}

const LottieAnimation10 = ({
  isRecording = false,
  audioLevel = 0.5,
  isPaused = false,
}: LottieAnimation10Props) => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <Player
        ...
        loop
        src="https://assets4.lottiefiles.com/packages/lf20_zzfmT4.json"
...
export default LottieAnimation10;
