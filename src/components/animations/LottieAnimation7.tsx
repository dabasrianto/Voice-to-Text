...
interface LottieAnimation7Props {
  isRecording?: boolean;
  audioLevel?: number;
  isPaused?: boolean;
}

const LottieAnimation7 = ({
  isRecording = false,
  audioLevel = 0.5,
  isPaused = false,
}: LottieAnimation7Props) => {
  ...
  return (
    <div className="w-full h-full flex items-center justify-center">
      <Player
        ...
        loop
        src="https://assets1.lottiefiles.com/packages/lf20_ot5gds8l.json"
...
export default LottieAnimation7;
